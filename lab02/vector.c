...
vector_t *bad_vector_new() {
    ...
    vector_t *retval, v;
    retval = &v;
    // Bad reason: v is allocated in the staic and will be removed, then retval will point to NULL.
...
vector_t also_bad_vector_new() {
    /* Create the vector */
    vector_t v;
    // Bad reason: v is allocated only in this function stack, and will be removed so long as you 
